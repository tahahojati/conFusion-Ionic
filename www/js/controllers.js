...
.controller('AppCtrl', ['$scope', '$ionicModal', '$timeout', '$localStorage','$ionicPlatform', '$cordovaCamera', function($scope, $ionicModal, $timeout, $localStorage, $ionicPlatform, $cordovaCamera) {
